...
function Final() {
    ...
    &:hover {
        transform: scale(1.1); // Increase the scale to make the image bigger on hover
      }
    `;
    ...
    return (
        <S.Container>
            ...
            <div style={{paddingTop: '2rem', alignItems:'center'}}>
                ...
                <LinkedinImage src={linkedinImage} style={{
                width:'70px', 
                paddingBottom: '8%', 
                margin:'0 20px 70px 0px', 
                }}></LinkedinImage></LinkedinLink>
                
        <GithubLink href='https://github.com/ThainazZ' target='_blank'>
            <GithubImage src={githubImage} style={{
                width:'70px', 
                paddingBottom: '8%', 
                margin:'0 0px 70px 20px',
               
                }}></GithubImage></GithubLink>
                </div>
        </S.Container>
